...
export default function AddFilm(props) {
    ...
    const formik = useFormik({
        ...
        onSubmit: values => {
            ...
            dispatch(addFilm(formData, props.history))
    ...
    return (
        <div>
            <div className='flex items-center gap-3 mb-4'>
                ...
                <span className='text-4xl text-blue-900 font-semibold'>Them phim moi</span>
            </div>
            ...
            <div className='-ml-16 pt-2'>
                ...
                >
                    ...
                    <Form.Item label="Ngay khoi chieu">
                        <DatePicker format='DD/MM/YYYY' placeholder='Chon ngay' name='ngayKhoiChieu'
                            onChange={value => setFieldValue('ngayKhoiChieu', moment(value).format('DD/MM/YYYY'))} />
                    ...
                    <Form.Item label="Dang chieu" valuePropName="checked">
                        <Switch name='dangChieu' onChange={value => setFieldValue('dangChieu', value)} />
                    </Form.Item>
                    <Form.Item label="Sap chieu" valuePropName="checked">
                        <Switch name='sapChieu' onChange={value => setFieldValue('sapChieu', value)} />
                    </Form.Item>
                    <Form.Item label="Hot" valuePropName="checked">
                        <Switch name='hot' onChange={value => setFieldValue('hot', value)} />
                    </Form.Item>
                    <Form.Item label="So sao">
                        <InputNumber defaultValue='1' min='0' max='10' name='danhGia' onChange={value => setFieldValue('danhGia', value)} />
                    </Form.Item>
                    ...
                    <Form.Item label="Tac vu">
                        <Button type='primary' htmlType='submit'>Them phim</Button>
                    </Form.Item>
                </Form>
            </div>
        </div>
